                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            Lista.Add(new Recepcion()
                            {
                                ...
                                PrecioInicial = Convert.ToDecimal(dr["PrecioInicial"].ToString(), new CultureInfo("es-ES")),
                                Adelanto = Convert.ToDecimal(dr["Adelanto"].ToString(), new CultureInfo("es-ES")),
                                PrecioRestante = Convert.ToDecimal(dr["PrecioRestante"].ToString(), new CultureInfo("es-ES")),
        ...
        public bool Registrar(Recepcion objeto)
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("FechaSalida", Convert.ToDateTime(objeto.FechaSalidaTexto,new CultureInfo("es-ES")));
                    cmd.Parameters.AddWithValue("PrecioInicial", Convert.ToDecimal(objeto.PrecioIncialTexto, new CultureInfo("es-ES")));
                    cmd.Parameters.AddWithValue("Adelanto", Convert.ToDecimal(objeto.AdelantoTexto, new CultureInfo("es-ES")));
                    cmd.Parameters.AddWithValue("PrecioRestante", Convert.ToDecimal(objeto.PrecioRestanteTexto, new CultureInfo("es-ES")));
        ...
        public bool Cerrar(Recepcion objeto)
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                ...
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand(query.ToString(), oConexion);
                    cmd.Parameters.AddWithValue("@totapagado", Convert.ToDecimal(objeto.TotalPagadoTexto,new CultureInfo("es-ES")));
                    cmd.Parameters.AddWithValue("@costopenalidad", Convert.ToDecimal(objeto.CostoPenalidadTexto, new CultureInfo("es-ES")));
